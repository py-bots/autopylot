...
def main(message):
    ...
    click.echo('\n'.join(message))
    click.echo("Congratulations! You have successfully installed Auto Pylot Python Library!", color='green', )
    click.echo("Auto Pylot Python Library is a free and open-source software library that is designed to simplify the process of automating the development of Python projects.", color='green')
